...
public abstract class LauncherAnimationRunner implements RemoteAnimationRunnerCompat {
    ...
    public void onAnimationStart(RemoteAnimationTargetCompat[] targetCompats, Runnable runnable) {
        ...
        if (mStartAtFrontOfQueue) {
            ...
            Utilities.postAsyncCallback(mHandler, r);
        }
    }
    ...
    public void onAnimationCancelled() {
        Utilities.postAsyncCallback(mHandler, this::finishExistingAnimation);
    }
    ...
    public static final class AnimationResult {
        ...
        public void setAnimation(AnimatorSet animation) {
            ...
            if (mAnimator == null) {
                ...
                mAnimator.setCurrentPlayTime(Utilities.SINGLE_FRAME_MS);
            }
        }
    }
}