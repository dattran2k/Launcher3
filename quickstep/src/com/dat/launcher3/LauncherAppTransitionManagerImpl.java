...
import com.dat.launcher3.graphics.DrawableFactory;
import com.dat.launcher3.shortcuts.DeepShortcutView;
import com.dat.launcher3.util.MultiValueAlpha;
import com.dat.quickstep.util.ClipAnimationHelper;
import com.dat.quickstep.util.MultiValueUpdateListener;
...
import com.dat.quickstep.TaskUtils;
...
public class LauncherAppTransitionManagerImpl extends LauncherAppTransitionManager
    ...
    public LauncherAppTransitionManagerImpl(Context context) {
        ...
        mDragLayerAlpha = mDragLayer.getAlphaProperty(DragLayer.ALPHA_INDEX_TRANSITIONS);
    ...
    public ActivityOptions getActivityLaunchOptions(Launcher launcher, View v) {
        if (hasControlRemoteAppTransitionPermission()) {
            ...
            boolean fromRecents = mLauncher.getStateManager().getState().overviewUi
                    && TaskUtils.findTaskViewToLaunch(launcher, v, null) != null;
    ...
    private boolean composeRecentsLaunchAnimator(View v,
        ...
        TaskView taskView = TaskUtils.findTaskViewToLaunch(mLauncher, v, targets);
        if (taskView == null) {
            return false;
        }
        ...
        target.play(TaskUtils.getRecentsWindowAnimator(taskView, skipLauncherChanges, targets, helper)
        ...
        if (launcherClosing) {
            ...
            AnimatorPlaybackController controller =
                    mLauncher.getStateManager().createAnimationToNewWorkspace(LauncherState.NORMAL, duration);
    ...
    private Pair<AnimatorSet, Runnable> getLauncherContentAnimator(boolean isAppOpening) {
        ...
        if (mLauncher.isInState(LauncherState.ALL_APPS)) {
            ...
            launcherAnimator.play(ObjectAnimator.ofFloat(allAppsController, AllAppsTransitionController.ALL_APPS_PROGRESS,
    ...
    private void playIconAnimators(AnimatorSet appOpenAnimator, View v, Rect windowTargetBounds) {
        ...
        int viewLocationStart = mIsRtl
                ...
                : viewLocationLeft;
        InsettableFrameLayout.LayoutParams lp = new InsettableFrameLayout.LayoutParams(rect.width(), rect.height());
        ...
        ObjectAnimator scaleAnim = ObjectAnimator
                .ofFloat(mFloatingView, LauncherAnimUtils.SCALE_PROPERTY, startScale, scale);
    ...
    private ValueAnimator getOpeningWindowAnimators(View v, RemoteAnimationTargetCompat[] targets,
        ...
        appAnimator.addUpdateListener(new MultiValueUpdateListener() {
            ...
            FloatProp mAlpha = new FloatProp(0f, 1f, 0, 60, Interpolators.LINEAR);
    ...
    private boolean launcherIsATargetWithMode(RemoteAnimationTargetCompat[] targets, int mode) {
        return TaskUtils.taskIsATargetWithMode(targets, mLauncher.getTaskId(), mode);
    }
            ...
            public void onCreateAnimation(RemoteAnimationTargetCompat[] targetCompats,
                ...
                if (!mLauncher.hasBeenResumed()) {
                    ...
                    mLauncher.setOnResumeCallback(() ->
                            Utilities.postAsyncCallback(mHandler, () ->
    ...
    private Animator getClosingWindowAnimators(RemoteAnimationTargetCompat[] targets) {
        ...
        closingAnimator.addUpdateListener(new MultiValueUpdateListener() {
            FloatProp mDy = new FloatProp(0, mClosingWindowTransY, 0, duration, Interpolators.DEACCEL_1_7);
            FloatProp mScale = new FloatProp(1f, 1f, 0, duration, Interpolators.DEACCEL_1_7);
            FloatProp mAlpha = new FloatProp(1f, 0f, 25, 125, Interpolators.LINEAR);
