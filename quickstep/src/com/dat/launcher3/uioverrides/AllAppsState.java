...
public class AllAppsState extends LauncherState {
    ...
    private static final PageAlphaProvider PAGE_ALPHA_PROVIDER = new PageAlphaProvider(Interpolators.DEACCEL_2) {
        @Override
    ...
    public AllAppsState(int id) {
        super(id, LauncherLogProto.ContainerType.ALLAPPS, LauncherAnimUtils.ALL_APPS_TRANSITION_MS, STATE_FLAGS);
    }
