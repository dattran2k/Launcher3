...
import com.dat.launcher3.LauncherInitListener;
...
public interface ActivityControlHelper<T extends BaseDraggingActivity> {
    ...
    class LauncherActivityControllerHelper implements ActivityControlHelper<Launcher> {
        ...
        public void onQuickInteractionStart(Launcher activity, RunningTaskInfo taskInfo,
            ...
            activity.getStateManager().goToState(LauncherState.FAST_OVERVIEW, activityVisible);
        ...
        public AnimationFactory prepareRecentsUI(Launcher activity, boolean activityVisible,
            ...
            if (!activityVisible) {
                ...
                activity.getStateManager().goToState(LauncherState.OVERVIEW, false);
        ...
        private void createActivityControllerInternal(Launcher activity, boolean wasVisible,
                ...
                @TouchConsumer.InteractionType int interactionType,
                Consumer<AnimatorPlaybackController> callback) {
            LauncherState endState = interactionType == TouchConsumer.INTERACTION_QUICK_SCRUB
                    ? LauncherState.FAST_OVERVIEW : LauncherState.OVERVIEW;
            if (wasVisible) {
            ...
            if (!activity.getDeviceProfile().isVerticalBarLayout()) {
                ...
                ObjectAnimator shiftAnim = ObjectAnimator.ofFloat(
                        controller, AllAppsTransitionController.ALL_APPS_PROGRESS, startProgress, endProgress);
                shiftAnim.setInterpolator(Interpolators.LINEAR);
                anim.play(shiftAnim);
            ...
            if (interactionType == TouchConsumer.INTERACTION_NORMAL) {
        ...
        private void playScaleDownAnim(AnimatorSet anim, Launcher launcher) {
            ...
            if (!clipHelper.getSourceRect().isEmpty() && !clipHelper.getTargetRect().isEmpty()) {
                ...
                Animator scale = ObjectAnimator.ofFloat(recentsView, LauncherAnimUtils.SCALE_PROPERTY, fromScale, 1);
                Animator translateY = ObjectAnimator.ofFloat(recentsView, TRANSLATION_Y,
                        fromTranslationY, 0);
                scale.setInterpolator(Interpolators.LINEAR);
                translateY.setInterpolator(Interpolators.LINEAR);
        ...
        @Override
        public MultiValueAlpha.AlphaProperty getAlphaProperty(Launcher activity) {
        ...
        public void onQuickInteractionStart(RecentsActivity activity, RunningTaskInfo taskInfo,
            ...
            if (activityVisible) {
                mUiHandler.postDelayed(controller::onFinishedTransitionToQuickScrub,
                        LauncherAnimUtils.OVERVIEW_TRANSITION_MS);
            }
        }
            ...
            return new AnimationFactory() {
                ...
                public void onRemoteAnimationReceived(RemoteAnimationTargetSet targets) {
                    ...
                    createActivityController(getSwipeUpDestinationAndLength(
                            activity.getDeviceProfile(), activity, TouchConsumer.INTERACTION_NORMAL,
                            new TransformedRect()), TouchConsumer.INTERACTION_NORMAL);
                }
                ...
                public void createActivityController(long transitionLength, int interactionType) {
                    ...
                    anim.setDuration(transitionLength).setInterpolator(Interpolators.LINEAR);
