 ...
 */
package com.dat.quickstep.logging;
    ...
    public void logActionTip(int actionType, int viewType) {
        ...
        switch(actionType) {
            ...
            case DISMISS:
                ...
                target.controlType = LauncherLogProto.ControlType.CANCEL_TARGET;
                break;
            default:
        ...
        LauncherLogProto.LauncherEvent event = LoggerUtils.newLauncherEvent(action, target);
