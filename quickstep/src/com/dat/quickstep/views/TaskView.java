...
import static com.dat.quickstep.views.TaskThumbnailView.DIM_ALPHA_MULTIPLIER;
...
import com.dat.quickstep.TaskSystemShortcut;
import com.dat.quickstep.TaskUtils;
import com.dat.quickstep.views.RecentsView.PageCallbacks;
import com.dat.quickstep.views.RecentsView.ScrollState;
    ...
    public TaskView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setOnClickListener((view) -> {
            ...
            BaseActivity.fromContext(context).getUserEventDispatcher().logTaskLaunchOrDismiss(
                    LauncherLogProto.Action.Touch.TAP, LauncherLogProto.Action.Direction.NONE, getRecentsView().indexOfChild(this),
