...
import static com.dat.launcher3.LauncherAppTransitionManagerImpl.ALL_APPS_PROGRESS_OFF_SCREEN;
...
public class LauncherRecentsView extends RecentsView<Launcher> {
    ...
    protected void startHome() {
        mActivity.getStateManager().goToState(LauncherState.NORMAL);
    }
    ...
    public AnimatorSet createAdjacentPageAnimForTaskLaunch(TaskView tv,
        ...
        if ((state.getVisibleElements(mActivity) & LauncherState.ALL_APPS_HEADER_EXTRA) != 0) {
        ...
        anim.play(ObjectAnimator.ofFloat(
                mActivity.getAllAppsController(), AllAppsTransitionController.ALL_APPS_PROGRESS, allAppsProgressOffscreen));
    ...
    protected void onTaskLaunched(boolean success) {
        if (success) {
            mActivity.getStateManager().goToState(LauncherState.NORMAL, false /* animate */);
        } else {
            LauncherState state = mActivity.getStateManager().getState();
