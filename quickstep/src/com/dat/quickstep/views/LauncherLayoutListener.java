...
import com.dat.quickstep.ActivityControlHelper.LayoutListener;
import com.dat.quickstep.WindowTransformSwipeHandler;
...
public class LauncherLayoutListener extends AbstractFloatingView
    ...
    public LauncherLayoutListener(Launcher launcher) {
        ...
        launcher.getRotationHelper().setStateHandlerRequest(RotationHelper.REQUEST_LOCK);
    }
    ...
    public void finish() {
        setHandler(null);
        close(false);
        mLauncher.getRotationHelper().setStateHandlerRequest(RotationHelper.REQUEST_NONE);
    }
}
