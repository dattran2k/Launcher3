...
package com.dat.quickstep.views;

import static com.dat.quickstep.TaskUtils.checkCurrentOrManagedUserId;
import static com.dat.quickstep.WindowTransformSwipeHandler.MIN_PROGRESS_FOR_OVERVIEW;
...
import com.dat.launcher3.Insettable;
import com.dat.launcher3.PagedView;
import com.dat.launcher3.R;
import com.dat.launcher3.Utilities;
import com.dat.launcher3.anim.AnimatorPlaybackController;
import com.dat.launcher3.anim.PropertyListBuilder;
import com.dat.launcher3.config.FeatureFlags;
import com.dat.launcher3.util.PendingAnimation;
import com.dat.launcher3.util.Themes;
import com.dat.quickstep.OverviewCallbacks;
...
import com.dat.quickstep.util.TaskViewDrawable;
...
public abstract class RecentsView<T extends BaseActivity> extends PagedView implements Insettable {
    ...
    private void addDismissedTaskAnimations(View taskView, AnimatorSet anim, long duration) {
        addAnim(ObjectAnimator.ofFloat(taskView, ALPHA, 0), duration, Interpolators.ACCEL_2, anim);
        addAnim(ObjectAnimator.ofFloat(taskView, TRANSLATION_Y, -taskView.getHeight()),
                duration, Interpolators.LINEAR, anim);
    }
        ...
        if (task != null) {
            ...
            if (shouldLog) {
                mActivity.getUserEventDispatcher().logTaskLaunchOrDismiss(
                        onEndListener.logAction, LauncherLogProto.Action.Direction.UP, index,
            ...
            if (child == taskView) {
                ...
                if (scrollDiff != 0) {
                    addAnim(ObjectAnimator.ofFloat(child, TRANSLATION_X, scrollDiff),
                            duration, Interpolators.ACCEL, anim);
    ...
    private void runDismissAnimation(PendingAnimation pendingAnim) {
        ...
        controller.setEndAction(() -> pendingAnim.finish(true, LauncherLogProto.Action.Touch.SWIPE));
        controller.getAnimationPlayer().setInterpolator(Interpolators.FAST_OUT_SLOW_IN);
        controller.start();
    }
    ...
    public PendingAnimation createTaskLauncherAnimation(TaskView tv, long duration) {
        ...
        drawableAnim.setInterpolator(Interpolators.LINEAR);
        drawableAnim.addUpdateListener((animator) -> {
            // Once we pass a certain threshold, update the sysui flags to match the target tasks'
            // flags
            mActivity.getSystemUiController().updateUiState(SystemUiController.UI_STATE_OVERVIEW,
        ...
        mPendingAnimation.addEndListener((onEndListener) -> {
            if (onEndListener.isSuccess) {
                ...
                if (task != null) {
                    mActivity.getUserEventDispatcher().logTaskLaunchOrDismiss(
                            onEndListener.logAction, LauncherLogProto.Action.Direction.DOWN, indexOfChild(tv),
                            TaskUtils.getLaunchComponentKeyForTask(task.key));
                }
            } else {
