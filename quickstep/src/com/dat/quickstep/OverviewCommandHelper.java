...
import com.dat.launcher3.MainThreadExecutor;
import com.dat.launcher3.anim.AnimationSuccessListener;
import com.dat.launcher3.logging.UserEventDispatcher;
import com.dat.quickstep.ActivityControlHelper.ActivityInitListener;
import com.dat.quickstep.ActivityControlHelper.AnimationFactory;
import com.dat.quickstep.ActivityControlHelper.FallbackActivityControllerHelper;
import com.dat.quickstep.ActivityControlHelper.LauncherActivityControllerHelper;
...
public class OverviewCommandHelper {
    ...
    private class RecentsActivityCommand<T extends BaseDraggingActivity> implements Runnable {
        ...
        private boolean onActivityReady(T activity, Boolean wasVisible) {
            ...
            if (wasVisible) {
                factory.createActivityController(RECENTS_LAUNCH_DURATION, TouchConsumer.INTERACTION_NORMAL);
            }
            mActivity = activity;
            mRecentsView = mActivity.getOverviewPanel();
            mRecentsView.setRunningTaskIconScaledDown(true /* isScaledDown */, false /* animate */);
            if (!mUserEventLogged) {
                activity.getUserEventDispatcher().logActionCommand(LauncherLogProto.Action.Command.RECENTS_BUTTON,
                        mHelper.getContainerType(), LauncherLogProto.ContainerType.TASKSWITCHER);
        ...
        private AnimatorSet createWindowAnimation(RemoteAnimationTargetCompat[] targetCompats) {
            ...
            mHelper.getSwipeUpDestinationAndLength(mActivity.getDeviceProfile(), mActivity,
                    TouchConsumer.INTERACTION_NORMAL, targetRect);
