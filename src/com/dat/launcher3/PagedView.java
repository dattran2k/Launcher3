...
import com.dat.launcher3.pageindicators.PageIndicator;
import com.dat.launcher3.touch.OverScroll;
import com.dat.launcher3.util.Thunk;
import com.dat.launcher3.compat.AccessibilityManagerCompat;
...
public abstract class PagedView<T extends View & PageIndicator> extends ViewGroup {
    ...
    private void sendScrollAccessibilityEvent() {
        if (AccessibilityManagerCompat.isObservedEventType(getContext(), AccessibilityEvent.TYPE_VIEW_SCROLLED)) {
