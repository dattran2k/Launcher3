...
package com.dat.launcher3.graphics;
...
import com.dat.launcher3.model.PackageItemInfo;
...
public class LauncherIcons implements AutoCloseable {
    ...
    private Bitmap createIconBitmap(Drawable icon, float scale) {
        ...
        if (Utilities.ATLEAST_OREO && icon instanceof AdaptiveIconDrawable) {
            int offset = Math.max((int) Math.ceil(ShadowGenerator.BLUR_FACTOR * textureWidth), Math.max(left, top));
