 ...
 */
package com.dat.launcher3.touch;

import static com.dat.launcher3.LauncherAnimUtils.MIN_PROGRESS_TO_ALL_APPS;
...
import static com.dat.launcher3.LauncherStateManager.ANIM_ALL;
import static com.dat.launcher3.LauncherStateManager.ATOMIC_COMPONENT;
import static com.dat.launcher3.LauncherStateManager.NON_ATOMIC_COMPONENT;
import static com.dat.launcher3.Utilities.SINGLE_FRAME_MS;
import static com.dat.launcher3.anim.Interpolators.scrollInterpolatorForVelocity;
...
import com.dat.launcher3.LauncherStateManager.AnimationComponents;
...
public abstract class AbstractStateChangeTouchController
    ...
    public void onDragEnd(float velocity, boolean fling) {
        final int logAction = fling ? LauncherLogProto.Action.Touch.FLING : LauncherLogProto.Action.Touch.SWIPE;
    ...
    protected int getDirectionForLog() {
        return mToState.ordinal > mFromState.ordinal ? LauncherLogProto.Action.Direction.UP : LauncherLogProto.Action.Direction.DOWN;
    }
