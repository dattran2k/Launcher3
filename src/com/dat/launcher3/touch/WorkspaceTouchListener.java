    ...
    public void run() {
        if (mLongPressState == STATE_REQUESTED) {
            if (canHandleLongPress()) {
                ...
                mLauncher.getUserEventDispatcher().logActionOnContainer(LauncherLogProto.Action.Touch.LONGPRESS,
                        LauncherLogProto.Action.Direction.NONE, LauncherLogProto.ContainerType.WORKSPACE,
