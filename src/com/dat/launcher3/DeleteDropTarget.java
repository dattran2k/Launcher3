...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    private int mControlType = LauncherLogProto.ControlType.DEFAULT_CONTROLTYPE;
    ...
    private void setControlTypeBasedOnDragSource(ItemInfo item) {
        mControlType = item.id != ItemInfo.NO_ID ? LauncherLogProto.ControlType.REMOVE_TARGET
                : LauncherLogProto.ControlType.CANCEL_TARGET;
    }
