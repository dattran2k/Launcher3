 ...
 */
package com.dat.launcher3.widget;
...
import com.dat.launcher3.graphics.ColorScrim;
...
import com.dat.launcher3.views.AbstractSlideInView;
...
abstract class BaseWidgetSheet extends AbstractSlideInView
    ...
    public void fillInLogContainerData(View v, ItemInfo info, LauncherLogProto.Target target, LauncherLogProto.Target targetParent) {
        targetParent.containerType = LauncherLogProto.ContainerType.WIDGETS;
        targetParent.cardinality = getElementsRowCount();
    }

    @Override
    public final void logActionCommand(int command) {
        LauncherLogProto.Target target = LoggerUtils.newContainerTarget(LauncherLogProto.ContainerType.WIDGETS);
