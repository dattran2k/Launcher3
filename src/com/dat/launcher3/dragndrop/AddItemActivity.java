...
package com.dat.launcher3.dragndrop;

import static com.dat.launcher3.logging.LoggerUtils.newCommandAction;
import static com.dat.launcher3.logging.LoggerUtils.newContainerTarget;
import static com.dat.launcher3.logging.LoggerUtils.newItemTarget;
import static com.dat.launcher3.logging.LoggerUtils.newLauncherEvent;
...
import com.dat.launcher3.LauncherAppWidgetHost;
...
import com.dat.launcher3.widget.WidgetImageView;
...
public class AddItemActivity extends BaseActivity implements OnLongClickListener, OnTouchListener {
    ...
    private void logCommand(int command) {
        getUserEventDispatcher().dispatchUserEvent(newLauncherEvent(
                ...
                newContainerTarget(LauncherLogProto.ContainerType.PINITEM)), null);
    }
}
