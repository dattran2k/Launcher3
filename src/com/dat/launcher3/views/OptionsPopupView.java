...
import static com.dat.launcher3.BaseDraggingActivity.INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION;
import static com.dat.launcher3.Utilities.EXTRA_WALLPAPER_OFFSET;
...
import com.dat.launcher3.popup.ArrowPopup;
...
public class OptionsPopupView extends ArrowPopup
    ...
    public static void showDefaultOptions(Launcher launcher, float x, float y) {
        ...
        options.add(new OptionItem(R.string.wallpaper_button_text, R.drawable.ic_wallpaper,
                LauncherLogProto.ControlType.WALLPAPER_BUTTON, OptionsPopupView::startWallpaperPicker));
        options.add(new OptionItem(R.string.widget_button_text, R.drawable.ic_widget,
                LauncherLogProto.ControlType.WIDGETS_BUTTON, OptionsPopupView::onWidgetsClicked));
        options.add(new OptionItem(R.string.settings_button_text, R.drawable.ic_setting,
                LauncherLogProto.ControlType.SETTINGS_BUTTON, OptionsPopupView::startSettings));
