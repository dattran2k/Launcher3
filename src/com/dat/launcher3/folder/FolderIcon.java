...
package com.dat.launcher3.folder;

import static com.dat.launcher3.folder.ClippedFolderIconLayoutRule.MAX_NUM_ITEMS_IN_PREVIEW;
...
public class FolderIcon extends FrameLayout implements FolderListener {
    ...
    public static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group,
        ...
        final boolean error = PreviewItemManager.INITIAL_ITEM_ANIMATION_DURATION >= DROP_IN_ANIMATION_DURATION;
        if (error) {
