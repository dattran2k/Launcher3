...
import com.dat.launcher3.model.DbDowngradeHelper;
import com.dat.launcher3.provider.LauncherDbUtils;
import com.dat.launcher3.provider.RestoreDbTask;
import com.dat.launcher3.util.NoLocaleSQLiteHelper;
...
public class LauncherProvider extends ContentProvider {
    ...
    /**
     * $ adb shell dumpsys activity provider com.dat.launcher3
     */
    @Override
    ...
    private ArrayList<Long> deleteEmptyFolders() {
        ...
        try (LauncherDbUtils.SQLiteTransaction t = new LauncherDbUtils.SQLiteTransaction(db)) {
            ...
            try (Cursor c = db.query(LauncherSettings.Favorites.TABLE_NAME,
    ...
    public static class DatabaseHelper extends NoLocaleSQLiteHelper implements AutoInstallsLayout.LayoutParserCallback {
        ...
        public boolean recreateWorkspaceTable(SQLiteDatabase db) {
            try (LauncherDbUtils.SQLiteTransaction t = new LauncherDbUtils.SQLiteTransaction(db)) {
                ...
                try (Cursor c = db.query(LauncherSettings.WorkspaceScreens.TABLE_NAME,
