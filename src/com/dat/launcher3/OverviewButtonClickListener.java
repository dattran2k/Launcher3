...
public abstract class OverviewButtonClickListener implements View.OnClickListener,
    ...
    private int mControlType; /** ControlType enum as defined in {@link LauncherLogProto.Action.Touch} */
    ...
    public boolean onLongClick(View view) {
        if (shouldPerformClick(view)) {
            handleViewClick(view, LauncherLogProto.Action.Touch.LONGPRESS);
        }
        return true;
    }
