...
import static com.dat.launcher3.LauncherAnimUtils.OVERVIEW_TRANSITION_MS;
import static com.dat.launcher3.LauncherAnimUtils.SPRING_LOADED_EXIT_DELAY;
import static com.dat.launcher3.LauncherAnimUtils.SPRING_LOADED_TRANSITION_MS;
import static com.dat.launcher3.LauncherState.ALL_APPS;
import static com.dat.launcher3.LauncherState.NORMAL;
import static com.dat.launcher3.LauncherState.SPRING_LOADED;
...
import com.dat.launcher3.Launcher.LauncherOverlay;
import com.dat.launcher3.LauncherStateManager.AnimationConfig;
import com.dat.launcher3.R;
import com.dat.launcher3.accessibility.AccessibleDragListenerAdapter;
import com.dat.launcher3.accessibility.WorkspaceAccessibilityHelper;
import com.dat.launcher3.anim.AnimatorSetBuilder;
import com.dat.launcher3.anim.Interpolators;
import com.dat.launcher3.badge.FolderBadgeInfo;
...
import com.dat.launcher3.dragndrop.DragOptions;
import com.dat.launcher3.dragndrop.DragView;
import com.dat.launcher3.dragndrop.SpringLoadedDragController;
import com.dat.launcher3.folder.Folder;
import com.dat.launcher3.folder.FolderIcon;
import com.dat.launcher3.folder.PreviewBackground;
import com.dat.launcher3.graphics.DragPreviewProvider;
import com.dat.launcher3.graphics.PreloadIconDrawable;
import com.dat.launcher3.pageindicators.WorkspacePageIndicator;
import com.dat.launcher3.popup.PopupContainerWithArrow;
import com.dat.launcher3.shortcuts.ShortcutDragPreviewProvider;
import com.dat.launcher3.touch.ItemLongClickListener;
import com.dat.launcher3.touch.WorkspaceTouchListener;
import com.dat.launcher3.util.ItemInfoMatcher;
import com.dat.launcher3.util.LongArrayMap;
import com.dat.launcher3.util.PackageUserKey;
import com.dat.launcher3.util.Thunk;
import com.dat.launcher3.util.WallpaperOffsetInterpolator;
...
public class Workspace extends PagedView<WorkspacePageIndicator>
    ...
    public void onOverlayScrollChanged(float scroll) {
        if (Float.compare(scroll, 1f) == 0) {
            if (!mOverlayShown) {
                mLauncher.getUserEventDispatcher().logActionOnContainer(LauncherLogProto.Action.Touch.SWIPE,
                        LauncherLogProto.Action.Direction.LEFT, LauncherLogProto.ContainerType.WORKSPACE, 0);
            }
            mOverlayShown = true;
            ...
            if (mOverlayShown) {
                mLauncher.getUserEventDispatcher().logActionOnContainer(LauncherLogProto.Action.Touch.SWIPE,
                        LauncherLogProto.Action.Direction.RIGHT, LauncherLogProto.ContainerType.WORKSPACE, -1);
        ...
        mLauncher.getDragLayer().getAlphaProperty(DragLayer.ALPHA_INDEX_OVERLAY).setValue(alpha);
    }
    ...
    protected void notifyPageSwitchListener(int prevPage) {
        ...
        if (prevPage != mCurrentPage) {
            int swipeDirection = (prevPage < mCurrentPage) ? LauncherLogProto.Action.Direction.RIGHT : LauncherLogProto.Action.Direction.LEFT;
            mLauncher.getUserEventDispatcher().logActionOnContainer(LauncherLogProto.Action.Touch.SWIPE,
                    swipeDirection, LauncherLogProto.ContainerType.WORKSPACE, prevPage);
        }
    }
