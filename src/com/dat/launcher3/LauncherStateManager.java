...
public class LauncherStateManager {
    ...
    public void prepareForAtomicAnimation(LauncherState fromState, LauncherState toState,
        ...
        if (fromState == LauncherState.NORMAL && toState.overviewUi) {
            builder.setInterpolator(AnimatorSetBuilder.ANIM_WORKSPACE_SCALE, Interpolators.OVERSHOOT_1_2);
            builder.setInterpolator(AnimatorSetBuilder.ANIM_WORKSPACE_FADE, Interpolators.OVERSHOOT_1_2);
            builder.setInterpolator(AnimatorSetBuilder.ANIM_OVERVIEW_SCALE, Interpolators.OVERSHOOT_1_2);
            builder.setInterpolator(AnimatorSetBuilder.ANIM_OVERVIEW_FADE, Interpolators.OVERSHOOT_1_2);
