...
package com.dat.launcher3.model;

import static com.dat.launcher3.ItemInfoWithIcon.FLAG_DISABLED_LOCKED_USER;
import static com.dat.launcher3.ItemInfoWithIcon.FLAG_DISABLED_SAFEMODE;
import static com.dat.launcher3.ItemInfoWithIcon.FLAG_DISABLED_SUSPENDED;
...
import com.dat.launcher3.AllAppsList;
import com.dat.launcher3.AppInfo;
import com.dat.launcher3.FolderInfo;
import com.dat.launcher3.IconCache;
import com.dat.launcher3.InstallShortcutReceiver;
import com.dat.launcher3.ItemInfo;
import com.dat.launcher3.LauncherAppState;
import com.dat.launcher3.LauncherAppWidgetInfo;
import com.dat.launcher3.LauncherModel;
...
import com.dat.launcher3.compat.LauncherAppsCompat;
import com.dat.launcher3.compat.PackageInstallerCompat;
import com.dat.launcher3.compat.UserManagerCompat;
...
import com.dat.launcher3.graphics.LauncherIcons;
import com.dat.launcher3.logging.FileLog;
import com.dat.launcher3.provider.ImportDataTask;
import com.dat.launcher3.shortcuts.DeepShortcutManager;
import com.dat.launcher3.shortcuts.ShortcutInfoCompat;
import com.dat.launcher3.shortcuts.ShortcutKey;
import com.dat.launcher3.util.ComponentKey;
import com.dat.launcher3.util.LooperIdleLock;
import com.dat.launcher3.util.MultiHashMap;
import com.dat.launcher3.util.PackageManagerHelper;
import com.dat.launcher3.util.Provider;
import com.dat.launcher3.util.TraceHelper;
import com.dat.launcher3.folder.ClippedFolderIconLayoutRule;
...
public class LoaderTask implements Runnable {
    ...
    private void sendFirstScreenActiveInstallsBroadcast() {
        ...
        LoaderResults.filterCurrentWorkspaceItems(firstScreen, allItems, firstScreenItems,
        ...
        synchronized (mBgDataModel) {
            ...
            for (FolderInfo folder : mBgDataModel.folders) {
                ...
                for (ShortcutInfo info : folder.contents) {
                    ...
                    if (numItemsInPreview >= ClippedFolderIconLayoutRule.MAX_NUM_ITEMS_IN_PREVIEW) {
                        break;
                    }
                }
            }
