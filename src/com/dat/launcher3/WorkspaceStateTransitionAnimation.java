...
import static com.dat.launcher3.LauncherAnimUtils.DRAWABLE_ALPHA;
import static com.dat.launcher3.LauncherAnimUtils.SCALE_PROPERTY;
import static com.dat.launcher3.LauncherState.HOTSEAT_ICONS;
import static com.dat.launcher3.LauncherState.HOTSEAT_SEARCH_BOX;

import android.view.View;
import android.view.animation.Interpolator;

import com.dat.launcher3.LauncherState.PageAlphaProvider;
...
public class WorkspaceStateTransitionAnimation {
    ...
    public void applyChildState(LauncherState state, CellLayout cl, int childIndex) {
        applyChildState(state, cl, childIndex, state.getWorkspacePageAlphaProvider(mLauncher),
                PropertySetter.NO_ANIM_PROPERTY_SETTER, new AnimatorSetBuilder(), new AnimationConfig());
    }
