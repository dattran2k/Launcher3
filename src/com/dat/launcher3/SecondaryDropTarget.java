...
import static com.dat.launcher3.ItemInfoWithIcon.FLAG_SYSTEM_MASK;
import static com.dat.launcher3.ItemInfoWithIcon.FLAG_SYSTEM_NO;
...
import com.dat.launcher3.Launcher.OnResumeCallback;
...
public class SecondaryDropTarget extends ButtonDropTarget implements OnAlarmListener {
    ...
    public LauncherLogProto.Target getDropTargetForLogging() {
        LauncherLogProto.Target t = LoggerUtils.newTarget(LauncherLogProto.Target.Type.CONTROL);
        t.controlType = mCurrentAccessibilityAction == LauncherAccessibilityDelegate.UNINSTALL ? LauncherLogProto.ControlType.UNINSTALL_TARGET
                : LauncherLogProto.ControlType.SETTINGS_BUTTON;
        return t;
    }
